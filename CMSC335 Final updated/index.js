import  {path, express, fetchAllPages, fileURLToPath, dotenv, MongoClient, ServerApiVersion } from './shared.js';

const app = express();
let suspectList = [];

suspectList = await fetchAllPages();
...
const uri = `mongodb+srv://md2233:TdGBjIoVnIZpt8VU@cluster0.u5pn5.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0`
